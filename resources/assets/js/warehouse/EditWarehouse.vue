				...
				<div class="col-sm-8">
					<div class="form-group">
						<div class="col-sm-8 col-sm-offset-4">
							...
							<button type="button" onClick="window.location.href='/warehouse'" class="btn btn-primary">Cancel</button>
						</div>
					</div>
				</div>
		...
		data() {
			return {
				form: new Form ({
					...
					warehouse_details: this.warehouse.warehouse_details,
				}),

				url: '/warehouse/' + this.warehouse.id
			}
		},
