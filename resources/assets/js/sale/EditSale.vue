					...
					<div class="col-sm-6">
						...
						<div :class="{ 'form-group': true, 'has-error': form.errors.has('sale_status') }">
							<label for="sale_status" class="col-sm-4 control-label">
								...
								<div class="col-sm-8">
								<select type="text" v-model="form.sale_status" @change="select" class="form-control" name="sale_status" id="sale_status">
				...
				<div class="col-sm-6">
					<div class="form-group">
						<div class="col-sm-8 col-sm-offset-4">
							...
							<button type="button" onClick="window.location.href='/sale'" class="btn btn-primary">Cancel</button>
						</div>
					</div>
				</div>
		...
		data() {
			return {
				...
				form: new Form ({
					...
					sale_invoiceNo: this.sale.sale_invoiceNo,
					product_id: this.sale.product_id,
					sale_quantity: this.sale.sale_quantity,
					sale_rate: this.sale.sale_rate,
					sale_total: this.sale.sale_total,
				}),

				url: '/sale/' + this.sale.id
			}
		},
