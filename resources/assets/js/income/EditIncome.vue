				...
				<div class="col-sm-6">
					<div class="form-group">
						<div class="col-sm-8 col-sm-offset-4">
							...
							<button type="button" onClick="window.location.href='/income'" class="btn btn-primary">Cancel</button>
						</div>
					</div>
				</div>
...
<script>
	export default {
		...
		data() {
			return {
				form: new Form ({
					income_paymentDate: this.income.income_paymentDate,
					income_paymentFrom: this.income.income_paymentFrom,
					income_amount: this.income.income_amount,
					income_paymentAccount: this.income.income_paymentAccount,
					income_paymentType: this.income.income_paymentType,
					income_details: this.income.income_details,
				}),

				url: '/income/' + this.income.id
			}
		},
